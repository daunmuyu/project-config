...
- **第1章** [什么是 Git](./git-recipes/sources/果壳中的Git.md)

### 第2篇 从零搭建本地代码仓库

本篇完全面向入门者。我假设你从零开始创建一个项目并且想用 Git 来进行版本控制，我们会讨论如何在你的个人项目中使用 Git，比如如何初始化你的项目，如何管理新的或者已有的文件，如何在远端仓库中储存你的代码。

- **第1章** [快速指南](./git-recipes/sources/Git简易指南(上).md)
- **第2章** [创建代码仓库](./git-recipes/sources/创建代码仓库.md)
- **第3章** [保存你的更改](./git-recipes/sources/保存你的更改.md)
- **第4章** [检查仓库状态](./git-recipes/sources/查看仓库状态.md)
- **第5章** [检出之前的提交](./git-recipes/sources/检出以前的提交.md)
- **第6章** [回滚错误的修改](./git-recipes/sources/回滚错误的修改.md)
- **第7章** [重写项目历史](./git-recipes/sources/重写项目历史.md)

### 第3篇 远程团队协作和管理

- **第1章** 快速指南
- **第2章** [保持同步](./git-recipes/sources/保持代码同步.md)
- **第3章** [创建 Pull Request](./git-recipes/sources/创建PullRequest.md)
- **第4章** [使用分支](./git-recipes/sources/使用分支.md)
- **第5章** [常见工作流比较](./git-recipes/sources/常见工作流比较.md)

### 第4篇 Git 命令详解

- **第1章** [图解 Git 命令](./git-recipes/sources/Git图解.md)

  如果你稍微理解 Git 的工作原理，这篇文章能够让你理解的更透彻。

### 第5篇 Git 实用贴士

- **第1章** [代码合并：Merge、Rebase 的选择](./git-recipes/sources/代码合并Merge还是Rebase.md)
